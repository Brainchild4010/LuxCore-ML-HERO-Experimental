...
OPENCL_FORCE_NOT_INLINE float3 Material_Sample(const uint matIndex, __global const HitPoint *hitPoint,
	...
	// Evaluation parameters
#if !defined(LUXRAYS_CUDA_DEVICE)
	// OpenCL GOLDSTAND: keep the hero wavelength at the bottom of
	// the material eval stack. GlassMaterial_Sample consumes it.
	EvalStack_PushFloat(mlDispersionWaveLength);
#endif
